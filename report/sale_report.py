...
class SaleReport(models.Model):
    ...
    is_jour_vente    = fields.Selection(_JOURS_SEMAINE, string="Jour vente")
    is_semaine_vente = fields.Integer(string="Semaine vente")
    is_mois_vente    = fields.Integer(string="Mois vente")
    is_annee_vente   = fields.Char(string="Année vente")
    commitment_date  = fields.Datetime("Date de livraison")
